...
def test_publishing_invalid_revision_litezip(
    ...
    expected_msgs = [
        {'id': 2,
         ...
         'item': 'collection.xml',
         'error': ('3:319 -- error: element "md:wordlist" not allowed anywhere; '
                   'expected element "md:abstract", "md:actors", "md:ancillary", '
                   '"md:content-id", "md:content-url", "md:course-code", "md:created", '
                   '"md:derived-from", "md:education-levellist", '
                   '"md:extended-attribution", "md:homepage", "md:institution", '
                   '"md:instructor", "md:keywordlist", "md:language", "md:license", '
                   '"md:objectives", "md:repository", "md:revised", "md:roles", '
                   '"md:short-title", "md:subjectlist", "md:subtitle", "md:title", '
                   '"md:version" or "md:version-history"'),
         },
        {'id': 2,
         'message': 'validation issue',
         'item': '{}/index.cnxml'.format(new_module.id),
         'error': ('5:460 -- error: element "md:wordlist" not allowed anywhere; '
                   'expected element "md:abstract", "md:actors", "md:content-id", '
                   '"md:content-url", "md:course-code", "md:created", '
                   '"md:derived-from", "md:education-levellist", '
                   '"md:extended-attribution", "md:homepage", "md:institution", '
                   '"md:instructor", "md:keywordlist", "md:language", "md:license", '
                   '"md:objectives", "md:repository", "md:revised", "md:roles", '
                   '"md:short-title", "md:subjectlist", "md:subtitle", "md:title" or '
                   '"md:version"'),
         },
        {'id': 2,
         'message': 'validation issue',
         'item': '{}/index.cnxml'.format(new_module.id),
         'error': ('5:920 -- error: element "md:keywordlist" incomplete; missing '
                   'required element "md:keyword"'),
         },
    ]
    assert resp.json['messages'] == expected_msgs
